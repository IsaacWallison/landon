import arrivalInfo from './data/arrival-info.json';
import servicesAmenities from './data/services-amenities.json';
    ...
    <div className="scene" id="hotelinfo">
      ...
      <article id="usefulinfo">
        <section id="arrivalinfo">
          ...
          <ul>
            {arrivalInfo.map((item) => (
              <li>
                <strong>{item.arrival}</strong> {item.info}
              </li>
            ))}
          </ul>
        </section>
        <section className="checklist" id="services">
          ...
          <ul>
            {servicesAmenities.map((serviceAmenitie, i) => (
              <li key={i}>{serviceAmenitie.text}</li>
            ))}
          </ul>
        </section>
